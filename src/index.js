...
let trainOneButton = document.querySelector('#trainOne');
trainOneButton.addEventListener("click", () => trainKnn('one'));

let trainTwoButton = document.querySelector('#trainTwo');
trainTwoButton.addEventListener('click', () => trainKnn('two'));

let trainThreeButton = document.querySelector('#trainThree');
trainThreeButton.addEventListener('click', () => trainKnn('three'));

let predictButton = document.querySelector('#predict');
predictButton.addEventListener('click', () => knnPredict());
...
async function knnPredict () {
    ...
    if (predictions.length > 0) {
        ...
        prediction.innerText = "Probeer het opnieuw";
    }
